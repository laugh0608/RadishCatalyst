...
- 2026-06-23 至 2026-06-24 已完成 UI / Art pass 前五包、核心循环两包和叙事节拍前两包：默认画面已有快捷补给、底部摘要、关键对象轮廓、设备关系、本地目标焦点、短循环读法、压短必经操作量、`现场记录` 和场景证据。
...
1. 基于 [Demo Narrative Beats V1](../features/demo-narrative-beats-v1.md) 第二包做一次实机画面复核，确认基地开场、污染边界和核心站能读出现场证据。
2. 若新增证据抢走可操作对象或变成噪声线条，回 UI / Art pass 做局部收束。
3. 若画面复核成立，继续围绕完整新档路径做 20 到 30 分钟体感复核。
