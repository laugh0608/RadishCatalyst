...
- [远程武器与工业供弹 V1](../features/slice-ranged-weapon-and-industrial-ammunition-v1.md) P1 已人工通过，P2 已获提交授权；下一步先补独立步枪物品图标，不跨入射击与 HUD。
...
3. 萝卜SAMA授权提交 P2，同时确认步枪物品图标应独立于人物持枪帧；下一步先制作并审阅单独枪体图标，再替换制造卡、背包与核心仓库引用。
4. 独立图标通过前不进入 P3，不实现射击、`1 / 2` 切换、弹体伤害、耗弹或战斗 HUD；有限电力和陌生玩家盲测继续冻结。
