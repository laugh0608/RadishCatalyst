...
当前为「首版 Demo 体验主干建设：外勤返回与基地再进入读法第一版」。

首版 Demo 完成规格：[Demo Definition V1](../features/demo-definition-v1.md)。

当前活跃细专题：[Demo Route Return And Base Reentry Readability V1](../features/demo-route-return-and-base-reentry-readability-v1.md)，验证外勤结果回到基地后，HUD / 地图 / 设备 / 对象提示能读出去哪个设备处理、收益改变了什么、下一次从哪里出发。

最近完成细专题：[Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md)、[Demo Functional Scene Gameplay Density V1](../features/demo-functional-scene-gameplay-density-v1.md)、[Demo Supply Pressure Pacing V1](../features/demo-supply-pressure-pacing-v1.md)、[Demo Quick Slot Supply Readability V1](../features/demo-quick-slot-supply-readability-v1.md) 与 [Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)，2026-06-17 至 2026-06-19 第一包已落地或通过退出判断。
...
3. 读当前活跃细专题 `docs/features/demo-route-return-and-base-reentry-readability-v1.md`，确认外勤返回、基地设备、HUD / 地图 / 对象反馈和检查范围。
4. 只在需要确认上一个阶段边界时，读 `docs/features/demo-functional-transition-spatial-playability-v1.md`、`docs/features/demo-functional-scene-gameplay-density-v1.md` 和 `docs/features/demo-supply-pressure-pacing-v1.md`。
...
- 当前只收束外勤返回与基地再进入读法：外勤结果回到基地后，必须读出处理设备、收益变化、下一次出发入口和回基地理由。
...
- 必须覆盖真实玩家路线、基地设备、HUD / 地图 / 反馈和自动检查；不因本轮新增存档 schema。
