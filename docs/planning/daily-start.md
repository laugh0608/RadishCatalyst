...
当前活跃细专题：[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)，第二包推进核心区尺度化；基地、晶体、污染边界和核心稳定站按玩家路线扩为可达场地。
...
- 原型视觉呈现第二包已推进到核心区尺度化：现有 12 区不扩数量，基地、晶体、污染边界和核心稳定站优先具备纵深、场地层和可达侧路。
