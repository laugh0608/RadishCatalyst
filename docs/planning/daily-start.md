...
- 2026-06-23 已完成 UI / Art pass 前五包和核心循环节奏第一包：默认画面已有快捷补给、底部摘要、关键对象轮廓、设备关系标记、本地目标焦点和核心循环短读法。
...
1. 优先继续 [Demo Core Loop Playable V1](../features/demo-core-loop-playable-v1.md)：从新档路径检查采集、加工、整备、污染承压、短战斗和核心写入的操作节奏，记录哪些步骤拖慢 20 到 30 分钟目标。
2. 对过长的主干段做节奏压缩或后置展示，优先处理晶体采集 -> 基地加工 -> 整备收益 -> 污染边界 -> 核心站这条玩家必经路径；不新增区域、资源、配方、长期系统或长提示。
3. 若核心循环节奏已顺，再启动 [Demo Narrative Beats V1](../features/demo-narrative-beats-v1.md) 第一包，把开场事故、基地恢复、污染信号、核心稳定和结尾钩子落成短反馈和场景证据。
