...
- 2026-06-21 已基于四张定位截图完成第二轮视觉修正：全图 cue、旧底板、价值路线、目标线和焦点文字进一步降权。
...
- 当前不切换专题；继续重截基地首屏、晶体矿脉、污染边界和核心稳定站，核对第二轮视觉修正是否成立。
...
- 用开发截图定位入口重新截取基地首屏、晶体矿脉、污染边界和核心稳定站四个状态，重点核对旧大色块、长路线和中心标签是否退后。
