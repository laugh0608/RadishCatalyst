...
当前为「首版 Demo 体验主干建设：中段异常地貌可玩路径第一版」。

首版 Demo 完成规格：[Demo Definition V1](../features/demo-definition-v1.md)。

当前活跃细专题：[Demo Midfield Route Playability V1](../features/demo-midfield-route-playability-v1.md)，覆盖回声台地 -> 盐壳浅滩 -> 碎晶沟谷的入口边界、资源 / 设施落点、回基地理由和自动检查。

最近完成细专题：[Demo Map Surface Decomposition V1](../features/demo-map-surface-decomposition-v1.md)、[Demo Interaction Prompt Surface Decomposition V1](../features/demo-interaction-prompt-surface-decomposition-v1.md)、[Demo Route Return And Base Reentry Readability V1](../features/demo-route-return-and-base-reentry-readability-v1.md)、[Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md) 与 [Demo Functional Scene Gameplay Density V1](../features/demo-functional-scene-gameplay-density-v1.md)，2026-06-17 至 2026-06-19 第一包已落地或通过退出判断。
...
3. 读当前活跃细专题 `docs/features/demo-midfield-route-playability-v1.md`，确认中段路线范围、玩家路径、场景层和检查范围。
4. 只在需要确认上一个阶段边界时，读 `docs/features/demo-map-surface-decomposition-v1.md`、`docs/features/demo-interaction-prompt-surface-decomposition-v1.md` 和 `docs/features/demo-functional-transition-spatial-playability-v1.md`。
...
- 当前推进中段异常地貌可玩路径：回声台地、盐壳浅滩和碎晶沟谷必须读出入口边界、资源 / 设施落点、下一段和回基地理由。
