...
当前活跃细专题：[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)，第二包推进核心区尺度化；优先把基地平台和晶体矿脉首段从示意图推进到可达场地。
...
- 原型视觉呈现第二包已开始：现有 12 区不扩数量，先让基地平台和晶体矿脉首段有纵深、场地层和可达侧路；后续再按核心区优先级处理污染边界和核心稳定站。
