...
- 2026-06-21 已基于四张定位截图完成第二轮视觉修正；随后继续完成晶体 / 污染截图主次治理：晶体细节层进入污染段退场，矿面改局部采掘端口，污染回流改局部服务端口，敌人焦点标签单行化。
...
- 当前不切换专题；继续重截基地首屏、晶体矿脉、污染边界和核心稳定站，核对晶体 / 污染主次治理后的画面是否成立。
...
- 用开发截图定位入口重新截取基地首屏、晶体矿脉、污染边界和核心稳定站四个状态，重点核对晶体大矿面、污染长条、旧底板和中心标签是否退后。
- 若首屏远端蓝 / 紫块、晶体大矿面、污染长条或核心右侧完成区仍抢眼，继续拆局部设备、地貌、施工和输出工作面。
