...
当前为「首版 Demo 体验主干建设：补给节奏与承压价值第一版」。

首版 Demo 完成规格：[Demo Definition V1](../features/demo-definition-v1.md)。

当前活跃细专题：[Demo Supply Pressure Pacing V1](../features/demo-supply-pressure-pacing-v1.md)，验证现有修复凝胶 / 抗污染药剂在制作、消耗、补回和关键压力节点中的真实价值。

最近完成细专题：[Demo Quick Slot Supply Readability V1](../features/demo-quick-slot-supply-readability-v1.md)、[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)、[Demo Action Blocker Recovery V1](../features/demo-action-blocker-recovery-v1.md)、[Demo Action Feedback Readability V1](../features/demo-action-feedback-readability-v1.md) 与 [Demo Interaction Affordance V1](../features/demo-interaction-affordance-v1.md)，2026-06-17 至 2026-06-18 第一包已落地。
...
3. 读当前活跃细专题 `docs/features/demo-supply-pressure-pacing-v1.md`，确认补给获得、消耗、补回、承压价值和检查范围。
4. 只在需要确认上一个阶段边界时，读 `docs/features/demo-quick-slot-supply-readability-v1.md`。
...
- 当前只收束现有补给节奏与承压价值：修复凝胶和抗污染药剂必须在真实玩家路线中体现制作、消耗、补回和压力差异。
