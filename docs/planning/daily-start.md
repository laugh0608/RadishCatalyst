...
当前活跃细专题：[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)，核心区尺度化和启动目标导引已推进，当前补首小时目标链场景导引。
...
- 原型视觉呈现已推进到首小时目标链场景导引：现有 12 区不扩数量，优先解决玩家能看到下一步但不知道该点哪个对象的问题。
