...
- 2026-06-23 至 2026-06-28 已完成 UI / Art pass 前十七包、核心循环、叙事节拍、首屏资产化、基地交接、污染短挑战、核心写入交接、Demo 结尾钩子和默认路径资产语言；晶体工作面同层几何路线已停手，下一步转资产化重建。
...
- 当前首要问题仍是纵切默认画面是否稳定像游戏；下一步优先推进晶体采集工作面资产化，不再追加同类程序线框包。
- 优先推进低保真游戏画面成型：晶体矿脉、采集器、输出托盘、局部地貌、角色动作、材质、阴影和短反馈。
- HUD、读法、状态整理和检查只能支撑画面成型，不能作为当前主线开发包。
- 每个开发包必须回答：玩家会看到什么、做什么、理解什么。

## 明日事项（2026-06-29）

1. 按 `Demo Crystal Workface Assetized Scene V1` 开工，先明确 #2 / #3 截图中玩家会看到什么、做什么、理解什么。
2. 处理已归档的晶体同层几何实验：保留必要回归保护，移除或绕开未通过的主体化叠层，由资产化工作面接管主读法。
3. 第一包优先交付当前矿脉、采集器机体、输出托盘、局部矿面和短物料流的低保真资产 / 场景节点；#1 / #4 只做回归观察。
