...
- 2026-06-21 已基于多轮定位截图继续完成晶体 / 污染主次治理：2 号晶体点位的旧蓝底、蓝色大 cue、横向路线和出发口对象 / 静态标签进一步退场；3 号污染边界的跨区残骸标签、蓝色长路线和旧黄绿底板继续降权，敌人场景标签不再承载 HP。
...
- 当前不切换专题；继续重截基地首屏、晶体矿脉、污染边界和核心稳定站，核对晶体局部采掘面、污染处理设施 / 沉积面和核心站完成态的画面是否成立。
...
- 用开发截图定位入口重新截取基地首屏、晶体矿脉、污染边界和核心稳定站四个状态，重点核对晶体碎矿面、采集点、残骸、装车回流线和污染处理设施 / 沉积面是否成立。
- 若首屏远端蓝 / 紫块、晶体蓝色底板、污染旧底板 / 长路线或核心右侧完成区仍抢眼，继续拆局部设备、地貌、施工和输出工作面；晶体点位优先确认整块蓝底、横向路线和出发口标签是否退场。
- 若四个状态读法成立，再推进低保真动态表现：设备状态灯节奏、资源 / 浆液流动、敌压警告和核心写入反馈。
