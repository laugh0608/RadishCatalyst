...
阶段：首次外勤战斗专题已收口；萝卜SAMA已授权切换到第一可玩切片全链串通，待建立专题。
...
主目标是建立第一可玩切片全链串通专题，先定义真实新档、无状态注入的 20 到 40 分钟完整路径与失败退出条件。

1. 收口并提交首次外勤战斗包 3。
2. 建立全链串通专题，归一章程与里程碑验收口径。
3. 新专题第一包只做全链审计和正式入口基线，不提前增加内容或视觉支线。
