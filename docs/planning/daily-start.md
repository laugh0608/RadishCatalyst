...
当前为「首版 Demo 体验主干建设：快捷补给读法第一版」。

首版 Demo 完成规格：[Demo Definition V1](../features/demo-definition-v1.md)。

当前活跃细专题：[Demo Quick Slot Supply Readability V1](../features/demo-quick-slot-supply-readability-v1.md)，当前收束现有修复凝胶 / 抗污染药剂在快捷栏中的可用、暂存和缺补给读法。

最近完成细专题：[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)、[Demo Action Blocker Recovery V1](../features/demo-action-blocker-recovery-v1.md)、[Demo Action Feedback Readability V1](../features/demo-action-feedback-readability-v1.md)、[Demo Interaction Affordance V1](../features/demo-interaction-affordance-v1.md) 与 [Demo Combat Evacuation Recovery V1](../features/demo-combat-evacuation-recovery-v1.md)，2026-06-17 至 2026-06-18 第一包已落地。
...
3. 读当前活跃细专题 `docs/features/demo-quick-slot-supply-readability-v1.md`，确认快捷补给状态、HUD、反馈和检查范围。
...
- 当前只收束现有快捷补给读法：修复凝胶和抗污染药剂在 HUD 快捷栏中必须读出数量、是否可用和缺口回补设备。
