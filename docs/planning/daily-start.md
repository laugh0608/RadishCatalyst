...
- 2026-06-23 至 2026-06-25 已完成 UI / Art pass 前九包、核心循环两包和叙事节拍前两包：默认画面已有快捷补给、底部摘要、关键对象轮廓、设备关系、本地目标焦点、局部画面收束、短循环读法、`现场记录`、场景证据、启动界面第一印象壳和基地首屏低保真工作现场。
...
1. 先用实机截图复核基地首屏是否仍像 debug 工作台；若成立，再推进 UI / Art 第十包，把同一低保真机器 / 材质语言延伸到晶体矿脉到基地交接段。
