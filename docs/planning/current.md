...
9 月 9 日收工，更改已本地提交至 `0f787b5a`，当晚仅继续文档复核与提交。9 月 10 日按 [Daily Start](daily-start.md) 补齐帧调度恢复对照与有效调用栈、原生关闭窗口保存路径；原因明确且短测稳定后再安排四档前台长测。计时 / 暂停、规模拆改、地图边缘和原生返回 / 重进已有窗口证据；后台长测不替代渲染性能。
