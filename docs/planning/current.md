...
- 当前活跃专题：[远程武器与工业供弹 V1](../features/slice-ranged-weapon-and-industrial-ammunition-v1.md)；P0 已获人工确认，当前进入 P1 资产目标，不接客户端。
...
4. UI P0 至 P2-E 已人工收口；[远程武器与工业供弹 V1](../features/slice-ranged-weapon-and-industrial-ammunition-v1.md) P0 已确认“切割器兜底 + 单把脉冲步枪 + 基地制造电池 + schema 8 物品持久化”，当前只做 P1 资产目标。有限电力和陌生玩家盲测继续暂停。
...
- 远程武器不重开近战 V1；当前草案只做固定脉冲步枪与电池，不新增敌人、地图、武器树、装填、自动供弹或 schema 9。专题确认前不新增资产或客户端逻辑。
