...
4. [游戏本体 UI 视觉定稿 V1](../features/slice-game-ui-visual-finalization-v1.md) P0 已完成，P1 四组主目标、核心仓库宽面板和损坏世界目录全屏系统均已获批准；核心仓库采用双栏直接拖拽，`Ctrl / Control` 拖拽一半，世界目录把损坏隔离、禁用动作和回收风险收在选中详情。只剩首次充能居中确认待目标稿。萝卜SAMA批准前不改 Theme、场景、控件或资产，核心仓库包 2、有限发电 / 负荷 / 储能和陌生玩家盲测继续暂停。
