...
- 首版 Demo 范围冻结、12 区域封顶、UI baseline、核心稳定站终点链路和冷启动试玩审计。
...
- 只修阻塞理解、主线连续性或试玩判断的断点。

## UI 策略

UI 和场景表现已完成第一轮可试玩呈现支撑。当前 UI 改动只服务当前活跃专题：制造 / 整备前后状态、模块收益、战斗承压变化和回基地价值要自然出现在 HUD、对象反馈和战斗日志里。
