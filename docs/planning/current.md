...
- 2026-06-21：多轮定位截图后的视觉修正已落地，并继续完成 2 号晶体点位与 3 号污染边界治理；晶体出发口标签、晶体大蓝 cue、污染跨区残骸标签、蓝色长路线和旧黄绿底板已进一步退场，下一步重截四个定位点核对画面。
...
当前不切换到试玩准备或修 bug 阶段；继续用开发截图定位点复核基地首屏、晶体矿脉、污染边界和核心稳定站四个状态，其中晶体点位确认碎矿面、采集点、残骸、装车回流线成为主读法，污染点位确认处理设施、沉积面、装车回流线和压力口袋不再被旧底板覆盖。
