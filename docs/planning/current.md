...
- 当前活跃专题：[Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md)，验证封锁遗迹到裂相脊代表路径的入口、可走边界、危险 / 资源 / 设施落点、回基地理由和自动检查。
- 最近完成：[Demo Functional Scene Gameplay Density V1](../features/demo-functional-scene-gameplay-density-v1.md)、[Demo Supply Pressure Pacing V1](../features/demo-supply-pressure-pacing-v1.md)、[Demo Quick Slot Supply Readability V1](../features/demo-quick-slot-supply-readability-v1.md)、[Demo Prototype Visual Pass V1](../features/demo-prototype-visual-pass-v1.md)、[Demo Action Blocker Recovery V1](../features/demo-action-blocker-recovery-v1.md)
...
- 2026-06-19：功能 / 过渡场景玩法密度第一版通过退出判断，当前切到功能 / 过渡场景可达空间第一版。

当前阶段：

```text
首版 Demo 体验主干建设：功能 / 过渡场景可达空间第一版
```

当前推进口径是功能 / 过渡场景可达空间第一版：不新增区域、资源、配方、任务链或敌人类型，只验证封锁遗迹到裂相脊代表路径能在实际场地里读出入口、可走边界、危险 / 资源 / 设施落点、回基地理由和自动检查证据。

## 当前主线

当前活跃专题是 [Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md)。它承接已完成的路线支撑、非核心场景识别、功能场景玩法和玩法密度专题，覆盖 [Demo Definition V1](../features/demo-definition-v1.md) 的「区域 / 场景」「功能 / 过渡场景」「UI / HUD」「存档 / 状态」和「自动检查」缺口。
...
- 功能 / 过渡场景可达空间第一包：封锁遗迹到裂相脊代表路径的入口、可走边界、危险 / 资源 / 设施落点、回基地理由和自动检查。
...
- [Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md) 建立并完成封锁遗迹到裂相脊代表路径检查。
- HUD、对象提示、交互结果和场景落点能读出入口、可走边界、下一段方向和回基地理由。
