...
- 当前处于专题切换：先完成“核心充能后的首次外勤战斗与关键样本回收”十问、五问和旧战斗代码复用审计；方案经萝卜SAMA确认后才进入实现。
...
```text
专题切换：核心充能后的首次外勤战斗与关键样本回收——设计与复用审计
```

## 当前主线

1. 配方加工 arc 与多世界存档均已收口，当前切片具备“工业成果落盘并可从真实列表选择”的稳定起点。
2. 下一专题只设计一次基础敌人遭遇、受击 / 撤离、关键样本回收和基地交付收益，先审计冻结旧战斗代码再决定复用。
3. 专题十问、开发包五问、HUD / 存档 / 正式入口和素材阶段边界经萝卜SAMA确认前，不进入实现。
...
- 十问与五问明确攻击 / 闪避、单敌人、受击 / 撤离、样本掉落 / 交付、基地整备收益、HUD、存档和正式入口范围。
- 旧战斗代码审计给出可复用、需重写和禁止复活清单；素材生成、审阅、接入与分包验证边界独立。
- 萝卜SAMA确认专题方案后，阶段切换到分包实现。
