...
- 当前活跃专题：[L4 传送带物流](../features/slice-conveyor-logistics-v1.md)。包 1 直线储物箱物流、可见晶体与 schema 5 的自动 / 正式入口证据已完成；下一步包 2 固定转角 / 端点素材与拓扑派生。arc 总览见[配方加工](../features/slice-recipe-processing-v1.md)。
...
2. L4 包 1 已完成；现在先过包 2 转角 / 端点固定素材硬闸门，再接拓扑刷新与折线路径，之后做包 3 合流与人工收口。
