...
- 当前活跃专题：[视觉层级与色彩分离 V1](../features/slice-visual-hierarchy-and-color-separation-v1.md)；局部窄修正不再作为路线出口，当前先完成世界 / UI 双目标稿门禁。
...
3. [视觉层级与色彩分离 V1](../features/slice-visual-hierarchy-and-color-separation-v1.md) 当前先按 [视觉方向决策框架](../reference/visual-direction-decision-framework.md) 制作 960×540 世界目标稿与 UI 目标稿；两稿都经萝卜SAMA批准后，才恢复 Theme、资产、场景和其他设备扩展。
