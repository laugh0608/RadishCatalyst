...
- 当前活跃专题：[远程武器与工业供弹 V1](../features/slice-ranged-weapon-and-industrial-ammunition-v1.md)；P1 已人工通过，P2 已获提交授权；进入 P3 前先补独立步枪物品图标，不复用整个人物持枪帧。
...
4. UI P0 至 P2-E 已人工收口；[远程武器与工业供弹 V1](../features/slice-ranged-weapon-and-industrial-ammunition-v1.md) P1 已以完整人物帧介质通过。P2 的财产、配方、唯一性、容量与 schema 8 兼容已获提交授权；独立步枪物品图标是进入 P3 前的视觉修正，P2 没有实现射击、切换、弹体或战斗 HUD。
...
- 远程武器不重开近战 V1；当前只做固定脉冲步枪与电池，不新增敌人、地图、武器树、装填、自动供弹或 schema 9。P2 只完成工业制造与库存财产，射击、切换、弹体和战斗 HUD 留给 P3。
