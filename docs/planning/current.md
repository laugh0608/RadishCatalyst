...
4. [游戏本体 UI 视觉定稿 V1](../features/slice-game-ui-visual-finalization-v1.md) P0 已完成，P1 世界 HUD、制造阻塞与背包 / 仓库、设备操作正常态与储物箱断链变体、晶体区战斗态四组主目标均已获批准；核心仓库、损坏世界目录和首次充能三种补充遮挡模型仍待目标稿。萝卜SAMA逐张批准前不改 Theme、场景、控件或资产，核心仓库包 2、有限发电 / 负荷 / 储能和陌生玩家盲测继续暂停。
