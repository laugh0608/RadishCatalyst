...
- 当前活跃专题：[Demo Midfield Route Playability V1](../features/demo-midfield-route-playability-v1.md)，覆盖回声台地 -> 盐壳浅滩 -> 碎晶沟谷的入口边界、资源 / 设施落点、回基地理由和自动检查。
- 最近完成：[Demo Map Surface Decomposition V1](../features/demo-map-surface-decomposition-v1.md)、[Demo Interaction Prompt Surface Decomposition V1](../features/demo-interaction-prompt-surface-decomposition-v1.md)、[Demo Route Return And Base Reentry Readability V1](../features/demo-route-return-and-base-reentry-readability-v1.md)、[Demo Functional Transition Spatial Playability V1](../features/demo-functional-transition-spatial-playability-v1.md)、[Demo Functional Scene Gameplay Density V1](../features/demo-functional-scene-gameplay-density-v1.md)
...
- 2026-06-19：功能 / 过渡场景玩法密度、可达空间、外勤返回与基地再进入读法、交互提示承载面和地图承载面均通过退出判断，当前切到中段异常地貌可玩路径第一版。

当前阶段：

```text
首版 Demo 体验主干建设：中段异常地貌可玩路径第一版
```

当前推进口径是中段异常地貌可玩路径第一版：不新增资源、配方、设备、区域、任务链或敌人类型，先把回声台地 -> 盐壳浅滩 -> 碎晶沟谷的入口边界、资源 / 设施落点和回基地理由落到 HUD、对象反馈、场景层与检查。

## 当前主线

当前活跃专题是 [Demo Midfield Route Playability V1](../features/demo-midfield-route-playability-v1.md)。它承接已完成的地图承载面拆分，覆盖 [Demo Definition V1](../features/demo-definition-v1.md) 的「区域 / 场景」「功能 / 过渡场景」「UI / HUD」「存档 / 状态」和「自动检查」缺口。
...
- 中段异常地貌可玩路径第一包：回声台地、盐壳浅滩和碎晶沟谷的入口边界、资源 / 设施落点、下一段和回基地理由接入 HUD、对象提示、场景层与专项检查。
...
- [Demo Midfield Route Playability V1](../features/demo-midfield-route-playability-v1.md) 建立并完成回声台地 -> 盐壳浅滩 -> 碎晶沟谷第一包。
- 三段路线的入口边界、资源 / 设施落点、下一段和回基地理由在 HUD、地图、对象提示、交互结果和场景层中可读。
