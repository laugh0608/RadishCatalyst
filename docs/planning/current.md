...
- 当前活跃专题：[L4 传送带物流](../features/slice-conveyor-logistics-v1.md)。包 1 直线物流与包 2 固定转角 / 端点、正交路径、环路回压的自动 / 正式入口证据已完成；下一步包 3 合流、公平性与人工收口。arc 总览见[配方加工](../features/slice-recipe-processing-v1.md)。
...
2. L4 包 1–2 已完成；现在推进包 3 双 / 三路合流固定帧、稳定轮询与人工收口，完成后切换 L5。
