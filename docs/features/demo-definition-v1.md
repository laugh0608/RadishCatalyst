...
| --- | --- | --- |
| Demo 完成定义 | 本文 | 已建立规格源 |
| 可玩内容实质补强 | `docs/features/demo-playable-content-substance-v1.md` | 当前活跃，角色 / 怪物 UI、核心场景空间、工业模块职责与任务节奏、初步美术识别和资源处理与外勤任务差异第一包已落地，后续继续补场景、设备表现和任务差异 |
...
4. 功能 / 过渡场景玩法密度、可达空间、中段路线、风蚀过渡、基地再进入读法、交互提示承载面、地图承载面、核心入口承接、核心稳定站内路径、设备面板读法、角色 / 怪物 UI、核心场景空间、工业模块职责与任务节奏、初步美术识别和资源处理与外勤任务差异均已完成第一包；当前继续做玩家可见场景、设备表现和任务差异开发。
