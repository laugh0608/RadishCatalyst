...
当前唯一活跃功能专题：[Slice Minimal Core Loop V1](slice-minimal-core-loop-v1.md)——最小核心循环（采集晶体 → 回基地 → 修复核心 + 最小 HUD），2026-07-17 择序开工。
...
- 后续专题候选（收口后由萝卜SAMA择序）：存档与状态持久化、立绘对话框最小接入、采集与建造扩展。
