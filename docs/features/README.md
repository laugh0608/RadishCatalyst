...
当前活跃专题：[Slice First Field Combat And Sample Recovery V1](slice-first-field-combat-and-sample-recovery-v1.md)——首次充能、鼠标瞄准战斗、单敌人、撤离、关键样本回收与基地交付；A2 敌人审阅 / 归一完成，等待独立 B1 战斗反馈生成，尚未开始玩法实现。
...
- 当前首次外勤战斗与关键样本回收进入独立素材阶段；后续候选保留立绘对话框最小接入、角色八方向动画（对角朝向生成风险高、排后续）。
