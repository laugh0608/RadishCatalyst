...
## 2026-06-25 下一包建议：基地首屏低保真游戏画面成型

- 新游戏进入后以基地首屏为主画面：前哨平台、玩家工程战斗员、前哨核心、基础反应器、储存箱、整备台、地面断供痕迹和局部阴影先形成可玩的工作现场。
- 设备要从色块和流程节点变成低保真机器：轮廓、端口、状态灯、物料托盘和短动作反馈优先，HUD 字段和说明只做辅助。
- 不新增区域、任务、资源、配方、存档字段或完整菜单 / 设置系统；不回到 5 / 6 单点重调，2 号问题只在挡住核心路径时局部处理。
