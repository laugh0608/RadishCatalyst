...
- 推进 UI / Art 第十一包：基地首屏残余规划层与空场收束，压掉远区黑场、竖向边界、蓝色横带和大规划矩形，让前哨工作面在默认首屏成为主读法。
- 右下小地图保留，但要减少文字、提高当前点 / 晶簇 / 污染 / 基地的视觉识别；复核通过后再把同一低保真机器 / 材质语言延伸到晶体矿脉到基地交接段。
- 仍不进入完整路径体感复核、试玩准备或集中修 bug；若 2 号晶体矿脉仍挡住核心路径，只做局部画面收束。
