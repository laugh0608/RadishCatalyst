...
const REGION_PROFILES := {
	"region.outpost_platform": {
		...
		"main_route_rect": Rect2(Vector2(-330.0, -74.0), Vector2(306.0, 38.0)),
		...
		"hazard_or_facility_rect": Rect2(Vector2(-218.0, -128.0), Vector2(126.0, 166.0)),
	...
	"region.crystal_vein_field": {
		...
		"main_route_rect": Rect2(Vector2(2.0, -252.0), Vector2(226.0, 34.0)),
		"key_object_path": "Interactables/CrystalCluster",
		"key_object_rect": Rect2(Vector2(6.0, -118.0), Vector2(224.0, 142.0)),
		"hazard_or_facility_path": "Interactables/AnomalyCrystal",
		"hazard_or_facility_rect": Rect2(Vector2(14.0, 92.0), Vector2(224.0, 158.0)),
	...
	"region.pollution_edge": {
		...
		"main_route_rect": Rect2(Vector2(244.0, -276.0), Vector2(132.0, 42.0)),
		"key_object_path": "Interactables/PollutionResidue",
		"key_object_rect": Rect2(Vector2(242.0, 14.0), Vector2(140.0, 236.0)),
		"hazard_or_facility_path": "OpeningSceneLayer/PollutionDeepResidueField",
		"hazard_or_facility_rect": Rect2(Vector2(240.0, 56.0), Vector2(150.0, 196.0)),
	...
	"region.demo_stabilization_core": {
		...
		"main_route_rect": Rect2(Vector2(3650.0, -254.0), Vector2(620.0, 54.0)),
		"key_object_path": "Interactables/DemoStabilizationCore",
		"key_object_rect": Rect2(Vector2(3920.0, -156.0), Vector2(174.0, 284.0)),
		"hazard_or_facility_path": "OpeningSceneLayer/CoreStabilizationGuardFieldGround",
		"hazard_or_facility_rect": Rect2(Vector2(3798.0, -176.0), Vector2(162.0, 318.0)),
