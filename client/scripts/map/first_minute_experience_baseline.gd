...
const LEGACY_PRESENTATION_NODE_PATHS := [
	...
	"RuinDirectionLabel",
	"DeepDirectionLabel",
	"InnerPhaseWellDirectionLabel",
	"PhaseWellSinkDirectionLabel",
	"PhaseWellChamberDirectionLabel",
	"PhaseWellLoomDirectionLabel",
	"PhaseWellFrameDirectionLabel",
	"PhaseWellTetherDirectionLabel",
	"DemoStabilizationCoreDirectionLabel",
	"OpeningSceneLayer",
