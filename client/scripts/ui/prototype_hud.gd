...
const PROMPT_RUNTIME_MAX_CHARACTERS := 76
const LOG_RUNTIME_MAX_CHARACTERS := 70
...
func _layout_runtime_panels(force: bool = false) -> void:
	...
	var margin := 18.0
	var gap := 10.0
	var objective_width := clampf(viewport_size.x * 0.25, 440.0, 560.0)
	var objective_height := 174.0
	var map_width := clampf(viewport_size.x * 0.16, 280.0, 340.0)
	var map_height := clampf(viewport_size.y * 0.2, 220.0, 260.0)
	var vitals_width := clampf(viewport_size.x * 0.24, 430.0, 520.0)
	var vitals_height := 118.0
	var quick_supply_width := clampf(viewport_size.x * 0.18, 340.0, 390.0)
	var quick_supply_height := 82.0
	var combat_width := clampf(viewport_size.x * 0.21, 380.0, 500.0)
	var combat_height := 164.0
	var prompt_width := clampf(viewport_size.x * 0.34, 560.0, 760.0)
	var prompt_height := 70.0
	var log_width := clampf(viewport_size.x * 0.24, 420.0, 560.0)
	var log_height := 62.0
	var action_summary_width := clampf(viewport_size.x * 0.34, 620.0, 780.0)
	var action_summary_height := 76.0
