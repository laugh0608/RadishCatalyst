...
func _check_startup_readability_scope() -> void:
	...
	if startup_layer != null:
		...
		_expect_equal(startup_layer.get_startup_asset_count() >= 9, true, "startup presentation registers first-screen sprite assets")
		...
		_expect_equal(startup_layer.has_startup_asset("startup_asset.basic_reactor_module"), true, "startup presentation has an assetized reactor sprite")
		_expect_equal(startup_layer.has_startup_asset("startup_asset.storage_crate_bank"), true, "startup presentation has an assetized storage sprite")
		_expect_equal(startup_layer.has_startup_asset("startup_asset.outfitting_station_rack"), true, "startup presentation has an assetized outfitting sprite")
		...
		_expect_equal(startup_layer.is_startup_asset_available("startup_asset.basic_reactor_module"), true, "startup reactor asset is loadable")
		_expect_equal(startup_layer.is_startup_asset_available("startup_asset.storage_crate_bank"), true, "startup storage asset is loadable")
		_expect_equal(startup_layer.is_startup_asset_available("startup_asset.outfitting_station_rack"), true, "startup outfitting asset is loadable")
		...
		_expect_equal(startup_layer.get_startup_asset_role("startup_asset.basic_reactor_module"), "processing_device", "startup reactor asset has a processing device role")
		_expect_equal(startup_layer.get_startup_asset_role("startup_asset.storage_crate_bank"), "storage_device", "startup storage asset has a storage device role")
		_expect_equal(startup_layer.get_startup_asset_role("startup_asset.outfitting_station_rack"), "outfitting_device", "startup outfitting asset has an outfitting device role")
		...
		_expect_equal(startup_layer.has_presentation_shape("startup_presentation.assetized_reactor_device"), true, "startup presentation draws the reactor from first-screen assets")
		_expect_equal(startup_layer.has_presentation_shape("startup_presentation.assetized_storage_device"), true, "startup presentation draws storage from first-screen assets")
