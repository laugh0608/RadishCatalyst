...
func _check_pollution_boundary_focus_visibility() -> void:
	...
	_expect_equal(region_value_layer.modulate.a <= 0.008, true, "pollution focus lowers region value layer")
	_expect_equal(cross_route.color.a <= 0.001, true, "pollution focus lowers crystal-to-pollution context route")
	_expect_equal(pollution_boundary.color.a <= 0.003, true, "pollution focus lowers pollution edge boundary frame")
	_expect_equal(ruin_boundary.color.a <= 0.003, true, "pollution focus lowers ruin edge boundary frame")
