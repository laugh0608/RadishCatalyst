...
func _check_opening_scene_layer() -> void:
	...
	if startup_presentation != null:
		...
		host._expect_equal(startup_presentation.has_presentation_shape("startup_presentation.actual_player_core_facing"), true, "startup presentation uses the actual player facing the core")
		host._expect_equal(startup_presentation.has_presentation_shape("startup_presentation.single_repair_pose_asset"), true, "startup presentation avoids stacked player drawings")
		...
		host._expect_equal(startup_presentation.has_presentation_shape("startup_presentation.short_repair_tool_feedback"), true, "startup presentation keeps repair feedback short")
		host._expect_equal(startup_presentation.has_presentation_shape("startup_presentation.core_status_chip_deemphasized"), true, "startup presentation lowers the round core status chip read")
		host._expect_equal(startup_presentation.has_presentation_shape("startup_presentation.right_background_linework_muted"), true, "startup presentation mutes right-side linework")
