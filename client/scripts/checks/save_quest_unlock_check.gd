...
func _check_rejects_active_quest_without_completed_quest_source() -> void:
	...
	save_data["world"]["quest_state"]["objective_progress"] = {
		...
		"quest.analyze_anomaly_sample|gather_item|item.anomaly_residue": 1,
		...
		"quest.expand_treatment_point|clear|map_object.rough_ground": 1,
		"quest.expand_treatment_point|build|building.foundation_t1": 1,
