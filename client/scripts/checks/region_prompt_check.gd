...
func run() -> void:
	...
	host._expect_text_contains(formatter.format_phase_well_loom_prompt(phase_well_loom_world, phase_well_loom_character), "相位井织核已带回基地", "phase well loom completed prompt")
