...
func run() -> void:
	...
	host._expect_text_contains(formatter.format_phase_well_chamber_prompt(phase_well_chamber_world, phase_well_chamber_character), "先回基地用基础反应器组装井心分流栓", "phase well chamber blocked prompt")
	phase_well_chamber_world.quest_state.completed_quest_ids.append("quest.assemble_phase_well_shunt")
	...
	host._expect_text_contains(formatter.format_phase_well_loom_prompt(phase_well_loom_world, phase_well_loom_character), "先回基地用基础反应器组装井纺梭栓", "phase well loom blocked prompt")
	phase_well_loom_world.quest_state.completed_quest_ids.append("quest.assemble_phase_well_shuttle")
	...
	host._expect_text_contains(formatter.format_phase_well_frame_prompt(phase_well_frame_world, phase_well_frame_character), "先回基地用基础反应器组装井纹架键栓", "phase well frame blocked prompt")
	phase_well_frame_world.quest_state.completed_quest_ids.append("quest.assemble_phase_well_frame_key")
	...
	host._expect_text_contains(formatter.format_phase_well_tether_prompt(phase_well_tether_world, phase_well_tether_character), "先回基地用基础反应器组装井系定桩", "phase well tether blocked prompt")
	phase_well_tether_world.quest_state.completed_quest_ids.append("quest.assemble_phase_well_tether_spike")
