...
func run() -> void:
	...
	host._expect_text_contains(formatter.format_phase_well_chamber_prompt(phase_well_chamber_world, phase_well_chamber_character), "相位井纺核已带回基地", "phase well chamber completed prompt")
