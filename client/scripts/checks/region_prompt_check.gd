...
func run() -> void:
	...
	host._expect_text_contains(formatter.format_inner_phase_well_prompt(inner_phase_well_world, inner_phase_well_character), "井芯样本已读取", "inner phase well completed prompt")
