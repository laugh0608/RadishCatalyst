...
func _check_base_first_screen_scene_layer() -> void:
	...
	_expect_equal(scene_layer.get_scene_asset_path("base_first_screen_scene.asset.rocky_ground"), "res://assets/sprites/demo_first_screen/base_first_screen_rocky_ground.svg", "base first screen rocky ground path is registered")
