...
$requiredTextByFile = @{
    ...
    "client/scripts/map/demo_first_industrial_path_handoff_art_pass.gd" = @(
        ...
        "first_path.handoff_continuity.return_tray.loaded",
        "first_path.handoff_continuity.reactor_hopper.processing",
        "first_path.handoff_continuity.hopper_cradle.processing",
        "first_path.handoff_continuity.supply_tote_lane.ready",
        "first_path.handoff_continuity.outfitting_supply.latched",
        "first_path.handoff_continuity.outfitting_lock_clamps.latched",
        "draw_devices",
        "draw_ports",
        "draw_feedback"
    )
    ...
    "client/scripts/checks/demo_resource_chain_state_check.gd" = @(
        ...
        "first industrial path layer compacts the base handoff lane",
        "first industrial path layer hides field workspots during base handoff",
        ...
        "first industrial path layer registers returned material tray body",
        "first industrial path layer draws one storage supply manifest",
        "first path compacts relation tracks during base handoff",
        "first path deemphasizes long field tracks during base handoff",
