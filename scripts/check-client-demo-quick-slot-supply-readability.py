...
def main() -> int:
    ...
    for relative_path, required_texts in REQUIRED_TEXT_BY_FILE.items():
        ...
        for required_text in required_texts:
            if required_text not in content:
                errors.append(f"{relative_path}: missing demo quick slot supply readability text '{required_text}'")
    ...
    print("Client demo quick slot supply readability checks passed.")
    return 0
